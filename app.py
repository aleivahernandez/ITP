...
st.markdown(
    ...
    <style>
        ...
        /* --- Google Patents style for patent results (simplified for direct st. components) --- */
        ...
        .result-image {
            flex-shrink: 0;
            width: 80px; /* Smaller image in results list */
            height: 80px;
            margin-right: 1rem;
            border-radius: 4px;
            object-fit: contain;
...
# --- Main Search View Logic (no detail view in this version) ---
